...
function virtual_machine(uuid, server_client) {
    ...
    self.config = {
        ...
        add_new_hd: function(bus, size, type) {
            ...
            if (!Number.isInteger(size)) {
                ...
                Private.hd_list.push({"size": size, "type": type, "bus": bus, "target": "sd" + hd_letter});
            }
        },
        ...
        add_interface: function(interface) {
            Private.interface_list.push({"interface": interface});
        },
